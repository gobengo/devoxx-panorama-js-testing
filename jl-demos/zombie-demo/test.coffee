...
describe 'Devoxx Serpodile', ->
	...
	it 'should add product to the basket', (done) ->
		browser = new Browser()
		browser.visit home, ->
	...
	it 'should add the product to the cookie', (done) ->
		browser = new Browser()
		browser.visit home, ->
			browser.clickLink '#mon-cahier-7', ->
			browser.cookies().get('serpodile_cart').should.contain 'mon-cahier-7'
			done()
